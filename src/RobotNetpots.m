    ...
    methods
        ...
        function self = RobotNetpots(numPots)
            ...
            for i = 1:steps
                ...
                if i < 5
                    self.netpotModel{i}.base = SE3(transl(-0.3, -0.2, 0.06-(i-1)*0.02)) * SE3(trotx(pi/2));
                ...
                if  5 <= i
                    self.netpotModel{i}.base = SE3(transl(-0.3, -0.1, 0.06-(i-5)*0.02)) * SE3(trotx(pi/2));
                ...
                if 8 < i
                    self.netpotModel{i}.base = SE3(transl(-0.3, 0, 0.06-(i-9)*0.02)) * SE3(trotx(pi/2));
                ...
                if 12 < i
                    self.netpotModel{i}.base = SE3(transl(-0.3, 0.1, 0.06-(i-13)*0.02)) * SE3(trotx(pi/2));
