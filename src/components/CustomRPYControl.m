classdef CustomRPYControl
    ...
    methods (Access = public)
        function self = CustomRPYControl(parent, app)
            ...
            self.PX.Layout.Column = 1;
            self.PX.Layout.Row = 1;
            self.PX.Text = "X +";
