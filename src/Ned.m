    ...
    methods
        ...
        function self =  stepNed(self)
            ...
            for i = 1 : steps
                ...
                if i <= 4
                    waypoint3 = transl(-0.2,-0.2,0.6) * trotx(-pi);
                ...
                if 4 < i
                    waypoint3 = transl(-0.025,0.3-(i-4)*0.05,0.2) * trotx(-pi);
                ...
                if 8 < i
                    waypoint3 = transl(0.025,0.3-(i-8)*0.05,0.2) * trotx(-pi);
                    waypoint = {waypoint1,waypoint2,waypoint3};
                ...
                if 12 < i
                    waypoint3 = transl(0.05,0.3-(i-12)*0.05,0.2) * trotx(-pi);
                    waypoint = {waypoint1,waypoint2,waypoint3};
