    ...
    methods
        ...
        function self = calcNextRoute(self)
            ...
            if mod(self.routeCount, 2) == 1
                ...
                guess = 0;
                if i <= 4
                    waypoint3 = transl(1.75-(i-1)*0.14,0.21,0.2) * trotx(-pi);
                    waypoint4 = transl(1.75-(i-1)*0.14,0.21,0.05) * trotx(-pi);
                ...
                if 4 < i
                    waypoint3 = transl(1.82+(i-5)*0.14,0.28,0.2) * trotx(-pi);
                    waypoint4 = transl(1.82+(i-5)*0.14,0.28,0.05) * trotx(-pi);
                ...
                if 8 < i
                    waypoint3 = transl(1.75+(i-9)*0.14,0.35,0.2) * trotx(-pi);
                    waypoint4 = transl(1.75+(i-9)*0.14,0.35,0.05) * trotx(-pi);
                ...
                if 12 < i
                    waypoint3 = transl(1.82+(i-13)*0.14,0.42,0.2) * trotx(-pi);
                    waypoint4 = transl(1.82+(i-13)*0.14,0.42,0.05) * trotx(-pi);
